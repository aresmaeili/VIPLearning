...
protocol NetworkProtocol {
    func createDataFromJson(with jsonName: String) -> aremDatas
}
...
class Network: NetworkProtocol {
    func createDataFromJson(with jsonName: String) -> aremDatas {
        ...
        guard let convertedData = try? decoder.decode(aremDatas.self, from: data) else { fatalError ("There was a problem decoding the data...") }
